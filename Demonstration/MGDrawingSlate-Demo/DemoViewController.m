...
- (IBAction)showInfo:(id)sender {
    ...
    UIAlertView *info = [[UIAlertView alloc] initWithTitle:@"About" message:@"Both MGDrawingSlate and this demonstration app are © 2012 MG App Development and are licensed for use under the MIT License. Some rights reserved.\n\nThe color picker used in this demonstration app is © 2011 InfinitApps, and is also licensed for use under the MIT License." delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
